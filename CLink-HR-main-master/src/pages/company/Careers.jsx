...
const JobCard = ({ title, location, type, department, delay }) => (
    ...
    >
        ...
        <button className="w-full py-4 rounded-2xl bg-white border-2 border-slate-100 text-slate-600 font-semibold hover:bg-brand-600 hover:text-white hover:border-brand-600 transition-all flex items-center justify-center gap-2 group/btn mt-auto">
                ...
                <div className="max-w-7xl ml-0 mr-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    ...
                    >
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                            <button onClick={() => document.getElementById('openings').scrollIntoView({ behavior: 'smooth' })} className="bg-brand-600 text-white px-10 py-4 rounded-full font-semibold hover:bg-brand-500 transition-all shadow-xl flex items-center justify-center gap-2">
