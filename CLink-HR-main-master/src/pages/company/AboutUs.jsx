        ...
        <div className="min-h-screen bg-slate-50">
            ...
            <section className="relative bg-brand-950 py-32 overflow-hidden">
                ...
                <div className="max-w-7xl ml-0 mr-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    ...
                    >
                        <span className="inline-block py-1 px-3 rounded-full bg-brand-800/50 border border-brand-700 text-brand-300 text-xs font-semibold tracking-widest uppercase mb-6 backdrop-blur-md">
                            Who We Are
                        </span>
