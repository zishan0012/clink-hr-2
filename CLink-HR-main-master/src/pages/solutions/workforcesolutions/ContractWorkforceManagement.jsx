    ...
    return (
        <div className="min-h-screen bg-slate-50">
                ...
                <div className="max-w-7xl ml-0 mr-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    ...
                    >
                        ...
                        <h1 className="text-3xl md:text-5xl lg:text-7xl font-bold text-white mb-8 tracking-tight leading-[1.1]">
                            ...
                            <span className="text-accent-500">Contract Workforce</span> at Scale
                        </h1>
                        <p className="text-xl md:text-2xl text-slate-200 mb-8 font-light max-w-4xl leading-relaxed">
                            CLink HR’s Contract Workforce Management solutions help organizations manage contractual and flexible workforce with clarity, control, and operational efficiency.
                        </p>
                        <div className="flex flex-col sm:flex-row gap-4">
                            <Link to="/contact/hire-talent" className="bg-brand-600 text-white px-8 py-4 rounded-full font-semibold hover:bg-brand-500 transition-all shadow-lg flex items-center justify-center gap-2">
                                Discuss Workforce Requirements <ArrowRight className="w-5 h-5" />
                            </Link>
                        </div>
                    </motion.div>
                </div>
            ...
            <section className="py-24 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl md:text-5xl font-bold text-slate-900 mb-6">Why Contract Workforce Management <span className="text-brand-600">Matters</span></h2>
                        <p className="text-xl text-slate-600 max-w-2xl mx-auto font-light">
                            Without proper management, contract workforce can create challenges. We help businesses manage them smoothly and reliably.
                        </p>
                    </div>

                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                        {[
                            { title: "Manage Demand", desc: "Manage fluctuating business demand effectively.", icon: Users },
                            { title: "Project Operations", desc: "Support project-based operations with flexible staffing.", icon: ClipboardCheck },
                            { title: "Cost Control", desc: "Control workforce costs while maintaining productivity.", icon: Wallet },
                            { title: "Flexibility", desc: "Maintain flexibility in staffing to adapt to market changes.", icon: CheckCircle }
                        ].map((item, i) => (
                            <motion.div
                                key={i}
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="grid lg:grid-cols-2 gap-16 items-center">
                        <div>
                            ...
                            <h2 className="text-3xl md:text-5xl font-bold text-slate-900 mb-6">Our Contract Workforce Management Approach</h2>
                            <p className="text-xl text-slate-600 mb-8 font-light">
                                Our approach focuses on centralized coordination and operational control. We provide one point of accountability.
                            </p>
                            <div className="space-y-6">
                                {[
                                    "Structured onboarding coordination",
                                    "Workforce data and documentation management",
                                    "Attendance and payroll coordination support",
            ...
            <section className="py-24 bg-white">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-16">
                        <h2 className="text-3xl md:text-5xl font-bold text-slate-900 mb-6">Scope of Contract Workforce Management Services</h2>
                    </div>
                        ...
                        {[
                            {
                                ...
                                items: ["Contract workforce onboarding coordination", "Documentation and record management", "ID and access coordination support"],
                                icon: FileText
                            },
                            {
                                title: "Workforce Administration Support",
                                items: ["Attendance and shift data coordination", "Leave and workforce movement tracking", "Ongoing workforce records maintenance"],
                                icon: Users
                            },
                            {
                                title: "Payroll & Payout Coordination",
                                items: ["Payroll data consolidation", "Payout coordination and tracking", "Query resolution support"],
                                icon: Wallet
                            },
                            {
                                title: "Compliance & Governance Support",
                                items: ["Workforce compliance coordination", "Documentation readiness", "Support during audits or reviews"],
                                icon: Shield
                            }
                        ].map((service, i) => (
            ...
            <section className="py-24 bg-slate-900 text-white relative overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="grid lg:grid-cols-2 gap-16">
                        ...
                        {/* Why Choose Card - Matching IT/Startup Design */}
                        <div>
                            <div className="bg-white text-slate-900 p-8 rounded-3xl shadow-2xl">
                                ...
                                <ul className="space-y-4">
                                    {[
                                        "Structured and process-driven workforce management",
                                ...
                                <p className="mt-10 text-slate-600 italic border-l-4 border-accent-500 pl-4">
                                    "We bring control and clarity to contract workforce operations."
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <section className="py-24 bg-white">
                <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <h2 className="text-3xl md:text-5xl font-bold text-slate-900 mb-12">Who Should Use Contract Workforce Management?</h2>
                    ...
                    <div className="bg-brand-50 rounded-[3rem] p-12 relative overflow-hidden">
                        <div className="relative z-10">
                            <h2 className="text-3xl font-bold text-brand-900 mb-6">Manage Contract Workforce with Confidence</h2>
                            <p className="text-xl text-brand-800/80 mb-8 max-w-3xl mx-auto">
                                Partner with CLink HR to streamline contract workforce management and focus on core business priorities.
                            </p>
                            <div className="flex flex-col sm:flex-row gap-4 justify-center">
                                <Link to="/contact/hire-talent" className="bg-brand-600 text-white px-10 py-4 rounded-full font-semibold hover:bg-brand-700 transition-all shadow-xl">
                                    Discuss Contract Workforce Requirements
                                </Link>
...
export default ContractWorkforceManagement;
