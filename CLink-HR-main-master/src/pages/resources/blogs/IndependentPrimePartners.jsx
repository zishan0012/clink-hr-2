...
import recruitmentEvolutionHero from '../../../assets/blog-img/Recruitment Evolution.jpg';
                    ...
                    <div className="mt-12 pt-8 border-t border-slate-100">
                        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                            <div className="text-center md:text-left">
                                <h4 className="text-lg font-bold text-slate-900 mb-2">Are you a recruiter looking for independence?</h4>
                                <p className="text-slate-600 text-sm">Join the IPP ecosystem today.</p>
                            </div>
                            <Link
