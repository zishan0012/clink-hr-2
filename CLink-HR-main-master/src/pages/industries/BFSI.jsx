                ...
                <div className="relative z-10 max-w-7xl ml-0 mr-auto px-4 sm:px-6 lg:px-8">
                    ...
                    >
                        ...
                        <p className="text-xl md:text-2xl text-slate-200 mb-8 font-light max-w-4xl leading-relaxed">
                            Scalable recruitment and compliance-driven HR solutions designed for the highly regulated banking, fintech, and financial services sectors.
                        </p>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4">
                            ...
                            >
                                Explore BFSI  <ArrowRight className="w-5 h-5" />
                            </Link>
                        </div>
                    </motion.div>
                </div>
