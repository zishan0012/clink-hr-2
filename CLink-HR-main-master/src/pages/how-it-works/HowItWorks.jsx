            ...
            <section className="py-24 bg-slate-900 text-center">
                <div className="max-w-4xl mx-auto px-4">
                    ...
                    <div className="flex flex-col sm:flex-row gap-6 justify-center">
                        ...
                        <Link to="/partners/ipp-partner-program" className="bg-white text-brand-900 px-10 py-4 rounded-full font-semibold hover:bg-slate-100 transition-all shadow-xl">
