...
import payrollHero from '../../../assets/services-img/Payroll & hr main page-hero.jpg';
import {
    Calculator,
    ShieldCheck,
    FileText,
            ...
            <section className="py-24 bg-white text-center">
                <div className="max-w-4xl mx-auto px-4">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <Link to="/contact/payroll-inquiry" className="bg-brand-600 text-white px-10 py-4 rounded-full font-semibold hover:bg-brand-700 transition-all shadow-xl hover:shadow-2xl hover:-translate-y-1">
                            Get a Quote
                        </Link>
                    </div>
                </div>
